...
\item[Title]\AsIs{Estimation des tendances régionales d'une prévalence à partir d'une EDS}
\item[Version]\AsIs{2.2}
\item[Date]\AsIs{2013-03-08}
\item[Author]\AsIs{Joseph Larmarange - CEPED (Université Paris Descartes Ined IRD) IRD, avec l'appui financier de l'ANRS et l'IRD, et le soutien technique de la SARL LYSIS (info@lysis-consultants.fr)}
\item[Maintainer]\AsIs{Joseph Larmarange }\email{joseph.larmarange@ird.fr}\AsIs{}
...
\item[Depends]\AsIs{R (>= 2.10), foreign, methods, sp, gstat, maptools, fields, GenKern, rgdal (>= 0.7-4), geoR, tcltk}
